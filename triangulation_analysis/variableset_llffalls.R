#
# Variable set for lower limb fractures + falls (combined) models --------------
#


X                <- "treatment"

Y                <- paste("outcome_llffalls_c"  , censoring_type, sep = "") 

followup_time    <- data[ ,paste("followup_days_llffalls_c"  , censoring_type, sep = "")]
