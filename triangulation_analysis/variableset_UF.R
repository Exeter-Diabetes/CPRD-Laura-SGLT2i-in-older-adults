#
# Variable set for volume depletion models -------------------------------------
#


X                <- "treatment"

Y                <- paste("outcome_urinary_frequency_c"  , censoring_type, sep = "")

followup_time    <- data[ ,paste("followup_days_UF_c"  , censoring_type, sep = "")] 
