#
# Variable set for amputation models -------------------------------------------
#


X                <- "treatment"

Y                <- paste("outcome_amputation_c"  , censoring_type, sep = "") 

followup_time    <- data[ ,paste("followup_days_amputation_c"  , censoring_type, sep = "")]
